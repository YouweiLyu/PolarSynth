...
scene = load_file('xml/sphere_pplastic_disLight.xml')

# Find differentiable scene parameters
params = traverse(scene)
print(params['Sphere.interior_medium.albedo.color.value'])
print(params['Sphere.bsdf.diffuse_reflectance.value'])
print(params['Sphere.interior_medium.sigma_t.color.value'])
print(params.keys()); exit()
